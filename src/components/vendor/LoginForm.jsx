        ...
        <Form className='p-8 px-8 rounded-lg'>
          <h2 className='text-4xl dark:text-gray-800 font-bold text-center m-4'>Manager Login </h2>
            ...
            <div className='flex flex-col text-black py-2'>
                ...
                <Field
                    className='pl-8 m-2 border-b-2 font-display focus:outline-none focus:border-black capitalize text-base'
                    type='password'
                    name='password'
                />
                <ErrorMessage
            ...
            <div className='flex justify-center'>
                  <p className='text-gray-400'><NavLink to={'/vendorsignup'}>Need a account?</NavLink></p>
              </div>
        </Form>
    </Formik>
