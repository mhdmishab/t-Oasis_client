...
function VendorCard() {
    return (
        ...
        <>
            <div className='w-72 h-48 bg-white rounded-lg mt-9   relative drop-shadow-[0_15px_15px_rgba(0,0,0,0.16)] hover:drop-shadow-xl '>
                ...
                <div className='w-60 h-52 bg-white rounded-md  ml-6 -mt-12 absolute'>
                    ...
                    <div className='flex-1 flex-col items-center mt-2'>
                        <h5 className='text-sm text-bold'>Lounge Name || calicut</h5>
                        <p className='mt-1 text-xs text-gray-600'>kerala</p>
                    </div>
