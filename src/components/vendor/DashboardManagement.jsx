...
function Dashboard() {
  ...
  const statsData = [
    ...
    { title: "Total Revenue", value:`₹${chartData?.totalRevenue[0]?.totalRevenue*(.8)}`, icon: <svg  className='w-8 h-8' fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
