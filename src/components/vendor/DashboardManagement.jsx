...
function Dashboard() {
  ...
  const statsData = [
    { title: "Average Lounge Rating", value:chartData?.avgLoungeRating[0]?.averageRating , icon:<svg className='w-8 h-8' fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          ...
          {[...Array(5)].map((_, index) => {
            ...
            return (
              <FaStar
                ...
                color={chartData?.avgLoungeRating[0]?.averageRating >= starNumber ? '#ffc107' : '#e4e5e9'}
              />
            );
          })}
        </div>
