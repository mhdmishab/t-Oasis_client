...
function UserFacilityCard({ facility }) {
  ...
  return (
    <>
      <div onClick={() => handleInsideCard(facility._id)} className='cursor-pointer w-72 h-48 bg-white rounded-lg mt-16 relative drop-shadow-[0_15px_15px_rgba(0,0,0,0.16)] hover:drop-shadow-xl m-3'>
