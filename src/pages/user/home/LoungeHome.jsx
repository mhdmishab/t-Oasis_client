...
function LoungeHome() {
  ...
  return (
    ...
    <div className="flex flex-col w-full">
      ...
      {userId && (
       <button
       className={`fixed bottom-2/4 transition duration-150 ease-out hover:ease-in right-4 sm:bottom-10 sm:right-10 z-10 bg-green-500 hover:bg-green-400 rounded-full p-4 cursor-pointer  ${
         isChatOpen ? "opacity-75" : "opacity-100"
       }`}
